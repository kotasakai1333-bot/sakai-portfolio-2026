export default function Home() {
  return (
    <div className="flex min-h-screen flex-1 justify-center px-4 py-6 text-sm text-zinc-100 sm:px-6 sm:py-10">
      <main className="glass-panel relative mx-auto flex w-full max-w-5xl flex-col gap-10 border border-white/10 px-5 py-6 sm:px-8 sm:py-8">
        <header className="flex flex-col gap-3 border-b border-white/5 pb-5 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-balance text-2xl font-semibold text-zinc-50 sm:text-3xl md:text-4xl">
              理学的な分析力で磨いた
